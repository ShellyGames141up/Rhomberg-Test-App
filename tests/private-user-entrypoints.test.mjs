...
const requiredRoles = [
  ...
  USER_ROLES.LABORATORY_USER, USER_ROLES.LABORATORY_MANAGER, USER_ROLES.QUALITY_ASSURANCE,
...
for (const role of [USER_ROLES.PLANNING, USER_ROLES.DISPATCH, USER_ROLES.LABORATORY_USER, USER_ROLES.LABORATORY_MANAGER, USER_ROLES.QUALITY_ASSURANCE, USER_ROLES.QUALITY_MANAGER, USER_ROLES.TECHNICAL_SUPPORT, USER_ROLES.TECHNICAL_DIRECTOR, USER_ROLES.SALES_MANAGER, USER_ROLES.COMPANY_OWNER, USER_ROLES.ADMINISTRATOR]) {
  assert.equal(applicationSurfaceAllowsRole(APPLICATION_SURFACES.DESKTOP, role), true);
