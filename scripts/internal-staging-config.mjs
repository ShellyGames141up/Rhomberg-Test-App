export const INTERNAL_STAGING_DEFAULT_API_URL = 'https://connect.rhom.co.za:8443/api/v1';
...
export function validateInternalStagingApiUrl(value) {
  ...
  if (parsed.hostname !== 'connect.rhom.co.za') throw new Error('Internal-staging API host must be connect.rhom.co.za.');
