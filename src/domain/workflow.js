...
export const RFQ_STATUSES = Object.freeze([
  ...
  'quotation_rejected',
  'amended_quotation_preparation',
  'amended_quotation_sent',
  'customer_accepted_pending_rep_verification',
  'po_correction_required',
  'closed_rejected',
  'quoted',
...
export const WORKFLOW_STATUS_DEFINITIONS = Object.freeze({
  [WORKFLOW_ENTITY_TYPES.RFQ]: Object.freeze({
    ...
    quotation_preparation: status('quotation_preparation', 'rfq', 'Quotation preparation', 'Your quotation is being prepared.', 'The assigned representative is preparing a quotation document.', true, 46),
    quotation_sent: status('quotation_sent', 'rfq', 'Quotation sent', 'A quotation is available for download and review.', 'An immutable quotation version was sent through the application.', true, 58),
    awaiting_customer_response: status('awaiting_customer_response', 'rfq', 'Quotation awaiting response', 'Review the current quotation, then accept it with a Purchase Order or reject it with a reason.', 'The current quotation version awaits the authorised customer response.', true, 64),
    quotation_rejected: status('quotation_rejected', 'rfq', 'Quotation rejected', 'Your rejection was sent to the representative.', 'The customer rejected the current quotation version.', true, 68),
    amended_quotation_preparation: status('amended_quotation_preparation', 'rfq', 'Amended quotation preparation', 'An amended quotation is being prepared.', 'The representative is preparing the next immutable quotation version.', true, 55),
    amended_quotation_sent: status('amended_quotation_sent', 'rfq', 'Amended quotation available', 'An amended quotation is available for download and response.', 'A new current quotation version superseded the rejected version.', true, 64),
    customer_accepted_pending_rep_verification: status('customer_accepted_pending_rep_verification', 'rfq', 'PO awaiting verification', 'Your quotation acceptance and Purchase Order were received for verification.', 'The representative must verify the accepted quotation and PO before conversion.', true, 78),
    po_correction_required: status('po_correction_required', 'rfq', 'PO correction required', 'Your representative requested a corrected Purchase Order.', 'The submitted PO requires customer correction.', true, 74),
    closed_rejected: status('closed_rejected', 'rfq', 'Closed after rejection', 'This RFQ was closed after the quotation was rejected.', 'The rejected RFQ is closed and retained with its complete history.', true, 100),
