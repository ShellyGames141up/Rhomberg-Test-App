...
export const validStandardsForWorksheet = ({ branchId, methodId, minimum, maximum, asOf = new Date().toISOString().slice(0, 10) }) => FABRICATED_REFERENCE_STANDARDS.filter(standard => (
