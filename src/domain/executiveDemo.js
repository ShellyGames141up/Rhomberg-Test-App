...
export const EXECUTIVE_DEMO_SCENARIOS = Object.freeze([
  ...
  Object.freeze({
    ...
    summary: 'Fabricated Pressure units use the launch manager-only certificate-upload workflow.',
    steps: Object.freeze([
      ...
      'Laboratory Manager opens the certificate queue and reviews the recipient snapshot',
      'Manager uploads one fabricated final PDF for physical unit one',
      'The multi-unit task remains active while another certificate is pending',
      'Manager uploads the remaining physical-unit certificate',
      'Customer and representative receive safe notifications',
      'Customer downloads the company-scoped current certificate',
      'The task moves to Completed Certificates with audit history preserved',
    ]),
  }),
  Object.freeze({
    id: 'traceable-calibration',
    label: 'Cape Town Temperature Laboratory',
    summary: 'Temperature instruments use the launch Traceable certificate-upload route.',
    steps: Object.freeze([
      ...
      'The combined Laboratory Manager reviews the recipient snapshot',
      'Manager uploads one fabricated Traceable PDF per physical unit',
      'The certificate register preserves the current version and history',
      'The completed task leaves the active queue',
  ...
  Object.freeze({
    ...
    summary: 'Historical branch scenario retained as a future inactive Laboratory architecture note.',
    steps: Object.freeze([
      'Planning routes a fabricated Pressure unit to Johannesburg',
      'The launch build does not expose technician access',
      'A permitted manager reviews the certificate recipient snapshot',
      'One final PDF is uploaded for each physical unit',
      'Completed work moves to searchable certificate history',
      'Customer access remains company-scoped and audited',
    ]),
  }),
  Object.freeze({
    id: 'qa-rework',
...
export const EXECUTIVE_DEMO_ROLES = Object.freeze([
  ...
  Object.freeze({ role: USER_ROLES.TECHNICAL_SUPPORT, label: 'Technical Advisor', stage: 'Assignment, review and completion', device: 'Operations Desktop' }),
  ...
  Object.freeze({ role: USER_ROLES.LABORATORY_MANAGER, label: 'Laboratory manager', stage: 'Final certificate upload', device: 'Operations' }),
