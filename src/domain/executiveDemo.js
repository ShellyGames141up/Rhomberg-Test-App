...
export const EXECUTIVE_DEMO_SCENARIOS = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'SANAS calibration journey',
    summary: 'Pressure instruments route through the Laboratory with unit-level certificates.',
    steps: Object.freeze([
      ...
      'Laboratory receives each physical unit',
      'Laboratory records calibration results',
      'Laboratory uploads one certificate per unit',
      'Laboratory manager releases the order',
      'Dispatch completes the authorised handover',
    ]),
  }),
  Object.freeze({
    id: 'traceable-calibration',
    label: 'Traceable calibration journey',
    ...
    steps: Object.freeze([
      ...
      'Laboratory performs unit-level work',
      'Traceable certificates are registered',
