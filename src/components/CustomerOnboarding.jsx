...
const FAKE_RFQ = Object.freeze({ reference: 'RQ-TUTORIAL-0001', productCode: 'PBG', productName: 'Bourdon Tube Pressure Gauge', representative: 'Example Representative' });
