  ...
  return (
    <header className="app-header">
      ...
      <div className="header-tools">
        ...
        {__PUBLIC_PREVIEW__ && !preview?.unified ? <a className="preview-status" href={preview?.executiveDemo ? '../../' : './'} title="Back to all test previews"><i /> {serviceMode === 'mock' ? 'Demo Preview' : 'Secure'}{preview?.platform ? ` · ${preview.platform}` : ''}</a> : <span className="preview-status"><i /> {__PUBLIC_PREVIEW__ && serviceMode === 'mock' ? 'Demo Preview' : 'Secure'}</span>}
