...
export const PERMISSIONS = Object.freeze({
  ...
  RESPOND_TO_QUOTATION: 'respond_to_quotation',
  VERIFY_PURCHASE_ORDER: 'verify_purchase_order',
  MANAGE_RFQ_DOCUMENTS: 'manage_rfq_documents',
  DOWNLOAD_AUTHORISED_DOCUMENTS: 'download_authorised_documents',
  CLOSE_REJECTED_RFQ: 'close_rejected_rfq',
...
export const ROLE_PERMISSIONS = Object.freeze({
  [USER_ROLES.CUSTOMER]: permissionList(
    ...
    PERMISSIONS.RESPOND_TO_QUOTATION,
    PERMISSIONS.DOWNLOAD_AUTHORISED_DOCUMENTS,
  ...
  [USER_ROLES.SALES_REPRESENTATIVE]: permissionList(
    ...
    PERMISSIONS.SEND_QUOTATION,
    PERMISSIONS.VERIFY_PURCHASE_ORDER,
    PERMISSIONS.MANAGE_RFQ_DOCUMENTS,
    PERMISSIONS.DOWNLOAD_AUTHORISED_DOCUMENTS,
    PERMISSIONS.CLOSE_REJECTED_RFQ,
...
export const WORKFLOW_ACTION_PERMISSIONS = Object.freeze({
  ...
  send_quotation: PERMISSIONS.SEND_QUOTATION,
  amend_quotation: PERMISSIONS.SEND_QUOTATION,
  accept_quotation: PERMISSIONS.RESPOND_TO_QUOTATION,
  reject_quotation: PERMISSIONS.RESPOND_TO_QUOTATION,
  verify_po_create_order: PERMISSIONS.VERIFY_PURCHASE_ORDER,
  close_rejected_rfq: PERMISSIONS.CLOSE_REJECTED_RFQ,
  reopen_rfq: PERMISSIONS.REOPEN_RFQ,
