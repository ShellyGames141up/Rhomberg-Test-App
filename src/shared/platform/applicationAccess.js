...
export const APPLICATION_ACCESS_MATRIX = Object.freeze({
  ...
  [USER_ROLES.LABORATORY_USER]: access(true, false),
  [USER_ROLES.LABORATORY_TECHNICIAN]: access(true, false),
  [USER_ROLES.LABORATORY_TEMPERATURE_TECHNICIAN]: access(true, false),
  [USER_ROLES.LABORATORY_MANAGER]: access(true, false),
  [USER_ROLES.TECHNICAL_SIGNATORY]: access(true, false),
  [USER_ROLES.LABORATORY_ADMINISTRATOR]: access(true, false),
