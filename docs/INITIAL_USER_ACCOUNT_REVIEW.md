# Initial User Account Review

The amended typed list dated 9 August 2026 replaces every earlier handwritten interpretation. It defines 25 staff identities: Cape Town 17, Port Elizabeth 1, Johannesburg 5 and Durban 2. Five people hold multiple roles through one identity. Four Laboratory staff use approved usernames because no work email was supplied.
...
Production approval remains outstanding for identity-provider integration, password policy, MFA, account invitations, employee verification, private image storage and the final imported seed transaction.
